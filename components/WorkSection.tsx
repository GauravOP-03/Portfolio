            ...
            <div className="max-w-7xl mx-auto px-4 md:px-10">
                ...
                <div className="flex flex-col lg:flex-row gap-12 items-center mb-32 group">
                    ...
                    >
                        ...
                        <div className="relative rounded-xl overflow-hidden border border-white/10 bg-[#0E1338] shadow-2xl hover:scale-[1.02] transition-transform duration-300">
                        ...
                        <div className="absolute -bottom-6 -right-6 glass p-4 rounded-xl border border-white/10 shadow-xl hidden md:flex items-center gap-4 bg-black/80 backdrop-blur-md">
                    ...
                    >
                        ...
                        <div className="flex flex-wrap gap-4 mt-4">
                            <Link href={"https://university-portal-frontend-ten.vercel.app/"} target="_blank" className="px-6 py-3 bg-white text-black font-bold rounded-lg flex items-center gap-2 hover:scale-105 transition-transform">
                ...
                <div className="flex flex-col lg:flex-row-reverse gap-12 items-center mb-32 group">
                    ...
                    >
                        ...
                        <div className="relative rounded-xl overflow-hidden border border-white/10 bg-[#1a0b2e] shadow-2xl hover:scale-[1.02] transition-transform duration-300">
                            <div className="h-8 bg-black/40 flex items-center px-4 gap-2 border-b border-white/5">
                                <div className="flex gap-1.5">
                    ...
                    >
                        ...
                        <div className="flex flex-wrap gap-4 mt-4">
                            <Link href={"https://github.com/scriptaiapp/scriptai"} target="_blank" className="px-6 py-3 bg-white/5 border border-white/10 text-white font-bold rounded-lg hover:bg-white/10 transition-colors flex items-center gap-2 hover:scale-105 transition-transform">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-slate-300 text-sm font-medium mb-6">
